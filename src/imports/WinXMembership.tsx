import svgPaths from "./svg-69xe1zpqye";
import imgImageOnlyOnePointerOnTheTimeScrubber from "../../Supership/Other projects/wi-h1.png";
import imgSummaryImage from "../../Supership/Other projects/wi-h1.png";
import imgImage3 from "../assets/project-placeholder.svg";
import imgImageOnlyOnePointerOnTheTimeScrubber1 from "../../Supership/Other projects/wi-c1.png";
import imgImageOnlyOnePointerOnTheTimeScrubber2 from "../../Supership/Other projects/wi-f1.png";
import imgImageOnlyOnePointerOnTheTimeScrubber3 from "../../Supership/Other projects/wi-f2.png";
import imgImageOnlyOnePointerOnTheTimeScrubber4 from "../../Supership/Other projects/wi-f3.png";
import imgImageOnlyOnePointerOnTheTimeScrubber5 from "../../Supership/Other projects/wi-f4.png";
import imgImageFigmaDesignPreview from "../../Supership/Other projects/wi-h1.png";
...
function ProjectDetailsContainer() {
  return (
    <div className="content-stretch flex gap-[12px] items-center opacity-60 relative shrink-0" data-name="Project Details Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[#fefcfc] text-[16px] whitespace-nowrap">[ Loyalty app ]</p>
    </div>
  );
}
...
function ProjectInfo() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center max-w-[612px] relative shrink-0 w-full" data-name="Project Info">
      <p className="font-['PP_NeueBit:Semi_Bold',sans-serif] leading-[72px] not-italic relative shrink-0 text-[#fefcfc] text-[80px] whitespace-nowrap">WinX Membership</p>
...
function Logo() {
  return (
    <div className="absolute bottom-[48px] content-stretch flex flex-col items-start right-[60px]" data-name="Logo">
      <div className="h-[40px] relative shrink-0 w-[164px]" data-name="image 3">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[130.39%] left-0 max-w-none top-0 w-[112.54%]" src={imgImage3} />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start relative shrink-0 w-full" data-name="Container">
      <ul className="block font-['Inter:Regular',sans-serif] font-normal leading-[0] list-disc not-italic relative shrink-0 text-[#1e1c1c] text-[18px] w-full">
        ...
        <li className="mb-0 ms-[27px]">
          <span className="leading-[28px]">1 BA</span>
        </li>
        <li className="mb-0 ms-[27px]">
          <span className="leading-[28px]">3 Product Designers</span>
        </li>
        <li className="mb-0 ms-[27px]">
          <span className="leading-[28px]">3 Mobile developers</span>
        </li>
        <li className="mb-0 ms-[27px]">
          <span className="leading-[28px]">1 Font-End deveoper</span>
        </li>
        <li className="ms-[27px]">
          <span className="leading-[28px]">Back- End team (Client interanal)</span>
        </li>
      </ul>
    </div>
  );
      ...
      <div className="content-stretch flex flex-col font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-start not-italic px-[20px] py-[40px] relative size-full text-[#1e1c1c]">
        ...
        <ul className="block leading-[0] min-w-full relative shrink-0 text-[18px] w-[min-content]">
          <li className="list-disc ms-[27px]">
            <span className="leading-[28px]">Mobile application</span>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div className="flex-[1_0_0] min-w-px mr-[-1px] relative self-stretch" data-name="Container">
      ...
      <div className="content-stretch flex flex-col font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-start not-italic px-[20px] py-[40px] relative size-full text-[#1e1c1c]">
        ...
        <ul className="block leading-[0] list-disc min-w-full relative shrink-0 text-[18px] w-[min-content]">
          ...
          <li className="mb-0 ms-[27px]">
            <span className="leading-[28px]">User interview</span>
          </li>
          <li className="ms-[27px]">
  ...
  return (
    <div className="flex-[1_0_0] min-w-px mr-[-1px] relative self-stretch" data-name="Container">
      ...
      <div className="content-stretch flex flex-col font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-start not-italic px-[20px] py-[40px] relative size-full text-[#1e1c1c]">
        ...
        <ul className="block leading-[0] min-w-full relative shrink-0 text-[18px] w-[min-content]">
          <li className="list-disc ms-[27px]">
            <span className="leading-[28px]">12 Months</span>
          </li>
        </ul>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[16px] items-start relative size-full">
        <div className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#1e1c1c] text-[18px] w-full whitespace-pre-wrap">
          <p className="leading-[28px] mb-0">WinX is a loyalty retail application designed for customers of WinMart, WinMart+, WiN, and partner brands.</p>
          <p className="leading-[28px] mb-0">The goal is to create a seamless ecosystem where users can earn, track, and redeem rewards across multiple platforms.</p>
          <p className="leading-[28px] mb-0">​</p>
          <p className="leading-[28px]">⚠️ (This project was not released due to changes in business strategy.)</p>
        </div>
      </div>
    </div>
  );
...
function ItemDescription() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start justify-center leading-[28px] min-w-px not-italic relative text-[#1e1c1c] text-[18px]" data-name="Item Description">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold relative shrink-0 w-full">Engaging concept</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal relative shrink-0 w-full">Focus on improving the customer experience.</p>
    </div>
  );
}
...
function ItemDescription1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[28px] min-w-px not-italic relative text-[#1e1c1c] text-[18px]" data-name="Item Description">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold relative shrink-0 w-full">Balance emotional experience with functional utility</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal relative shrink-0 w-full">The app needs to deliver strong emotional impact while still supporting essential tasks like QR scanning, rewards, and transactions.</p>
    </div>
  );
}
...
function ItemDescription2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[28px] min-w-px not-italic relative text-[#1e1c1c] text-[18px]" data-name="Item Description">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold relative shrink-0 w-full">Design for a large and complex ecosystem</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal relative shrink-0 w-full">The platform must support multiple brands, merchants, and use cases while keeping the experience simple and easy to navigate.</p>
    </div>
  );
}
...
function Competitor() {
  return (
    <div className="content-stretch flex items-center justify-center px-[32px] py-[12px] relative rounded-none shrink-0" data-name="Competitor">
      ...
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[28px] not-italic relative shrink-0 text-[#1e1c1c] text-[18px] whitespace-nowrap">Bach hoa xanh</p>
    </div>
  );
}
...
function Competitor1() {
  return (
    <div className="content-stretch flex items-center justify-center px-[32px] py-[12px] relative rounded-none shrink-0" data-name="Competitor">
      <div aria-hidden="true" className="absolute border border-black border-solid inset-0 pointer-events-none rounded-none" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[28px] not-italic relative shrink-0 text-[#1e1c1c] text-[18px] whitespace-nowrap">Go!</p>
    </div>
  );
}
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[16px] items-start relative size-full">
        <div className="bg-white relative shrink-0 w-full" data-name="Container">
          ...
          <div className="content-stretch flex flex-col gap-[8px] items-start not-italic px-[32px] py-[20px] relative size-full">
            <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[#1e1c1c] text-[18px] w-full">How can we make rewards feel more meaningful?</p>
            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#626060] text-[16px] w-full">Rewards matter more when they can be used at the right time, not just collected.</p>
          </div>
        </div>
        <div className="bg-white relative shrink-0 w-full" data-name="Container">
          <div aria-hidden="true" className="absolute border-[#1e1c1c] border-l-3 border-solid inset-0 pointer-events-none shadow-[0px_1px_4px_0px_rgba(0,0,0,0.04)]" />
          <div className="content-stretch flex flex-col gap-[8px] items-start not-italic px-[32px] py-[20px] relative size-full">
            <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[#1e1c1c] text-[18px] w-full">How can we encourage continuous engagement?</p>
            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#626060] text-[16px] w-full">Users return more often when benefits feel useful and connected to their daily life.</p>
          </div>
        </div>
        <div className="bg-white relative shrink-0 w-full" data-name="Container">
          <div aria-hidden="true" className="absolute border-[#1e1c1c] border-l-3 border-solid inset-0 pointer-events-none shadow-[0px_1px_4px_0px_rgba(0,0,0,0.04)]" />
          <div className="content-stretch flex flex-col gap-[8px] items-start not-italic px-[32px] py-[20px] relative size-full">
            <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[#1e1c1c] text-[18px] w-full">How can we reduce wasted points?</p>
            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#626060] text-[16px] w-full">Unused points lose value over time and reduce user motivation.</p>
          </div>
        </div>
      </div>
    </div>
...
function Container17() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start not-italic relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[#1e1c1c] text-[20px] w-full">Design a signature, character-led experience</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#626060] text-[16px] w-full">Introduce Bok Bok as an emotional companion to create a unique and memorable interaction layer beyond standard UI.</p>
    </div>
  );
}
...
function Container18() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start not-italic relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[#1e1c1c] text-[20px] w-full">Combine utility and emotion on the home screen</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#626060] text-[16px] w-full">Balance quick actions (QR scan, rewards) with engaging content (missions, discovery) to support different user intents.</p>
    </div>
  );
}
...
function Container19() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start not-italic relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[#1e1c1c] text-[20px] w-full">Structure the experience around missions and progress</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#626060] text-[16px] w-full">Use missions and reward systems to guide user behavior and create habit loops.</p>
    </div>
  );
}
...
function Container20() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start not-italic relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[#1e1c1c] text-[20px] w-full">Enable point sharing within a trusted circle</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#626060] text-[16px] w-full">Allow users to share points with family and close friends to reduce waste and increase usage.</p>
    </div>
  );
}
    ...
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center max-w-[400px] min-w-px pb-px relative" data-name="Container">
      <div className="mb-[-1px] relative shrink-0 w-full" data-name="Container">
        ...
        <div className="content-stretch flex flex-col gap-[8px] items-start not-italic px-[32px] py-[16px] relative size-full">
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[44px] relative shrink-0 text-[#fefcfc] text-[32px] whitespace-nowrap">New concept</p>
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] min-w-full relative shrink-0 text-[#d6d6d6] text-[16px] w-[min-content]">Focus on customer experience while supporting business requirements.</p>
        </div>
      </div>
      <div className="mb-[-1px] relative shrink-0 w-full" data-name="Container">
        <div aria-hidden="true" className="absolute border border-[#f6f6f6] border-solid inset-0 pointer-events-none" />
        <div className="content-stretch flex flex-col gap-[8px] items-start not-italic px-[32px] py-[16px] relative size-full">
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[44px] relative shrink-0 text-[#fefcfc] text-[32px] whitespace-nowrap">↓</p>
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] min-w-full relative shrink-0 text-[#d6d6d6] text-[16px] w-[min-content]">Design updates can be made faster without heavy developer involvement.</p>
        </div>
      </div>
      <div className="mb-[-1px] relative shrink-0 w-full" data-name="Container">
        <div aria-hidden="true" className="absolute border border-[#f6f6f6] border-solid inset-0 pointer-events-none" />
        <div className="content-stretch flex flex-col gap-[8px] items-start not-italic px-[32px] py-[16px] relative size-full">
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[44px] relative shrink-0 text-[#fefcfc] text-[32px] whitespace-nowrap">100% adoption</p>
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] min-w-full relative shrink-0 text-[#d6d6d6] text-[16px] w-[min-content]">Clear design guidelines are available for teams to follow across use cases.</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Quote">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pl-[32px] relative size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[28px] not-italic relative shrink-0 text-[#1e1c1c] text-[18px] w-full">Designers also need business thinking — to understand where design can create real value.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start min-w-px relative" data-name="Container">
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#626060] text-[16px] w-full">
        <p className="leading-[24px] mb-0">This project focused strongly on user experience and real user needs.</p>
        <p className="leading-[24px]">It required careful research and close collaboration with the team to define clear logic and direction.</p>
      </div>
      <Quote />
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#626060] text-[16px] w-full">
        <p className="leading-[24px] mb-0">Working closely with business teams helped me better understand their goals and expectations.</p>
        <p className="leading-[24px] mb-0">I learned how to find the balance between user needs and business objectives - not just as an idea, but as something that must be applied in real products.</p>
        <p className="leading-[24px]">Creating real value should always be the top priority.</p>
      </div>
    </div>
  );
}
...
function Container25() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start not-italic relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[#1e1c1c] text-[20px] w-full">Figmap</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#626060] text-[16px] w-full">Description</p>
    </div>
  );
}
...
function ProjectPageWinX() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-w-px pb-px relative" data-name="Project page / WinX">
...
export default function WinXMembership() {
  return (
    <div className="bg-[#f6f6f6] content-stretch flex items-start relative size-full" data-name="WinX Membership">
