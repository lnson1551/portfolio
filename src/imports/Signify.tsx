import svgPaths from "./svg-7pa1yrt5v6";
// Hero + design screenshots → Signify card image (verified working)
import imgImageOnlyOnePointerOnTheTimeScrubber from "../../Supership/Other projects/si-h1.png";
import imgSummaryImage from "../../Supership/Other projects/si-h1.png";
import imgImageOnlyOnePointerOnTheTimeScrubber1 from "../../Supership/Other projects/si-c1.png";
import imgImageOnlyOnePointerOnTheTimeScrubber2 from "../../Supership/Other projects/si-f1.png";
import imgImageOnlyOnePointerOnTheTimeScrubber3 from "../../Supership/Other projects/si-f2.png";
import imgImageOnlyOnePointerOnTheTimeScrubber4 from "../../Supership/Other projects/si-f3.png";
import imgImageOnlyOnePointerOnTheTimeScrubber5 from "../../Supership/Other projects/si-f4.png";
import imgImageFigmaDesignPreview from "../../Supership/Other projects/si-h1.png";
...
function ProjectDetailsContainer() {
  return (
    <div className="content-stretch flex gap-[12px] items-center opacity-60 relative shrink-0" data-name="Project Details Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[#fefcfc] text-[16px] whitespace-nowrap">[ Sign languages AI real-time intepret application for Deaf-Mute comunity ]</p>
    </div>
  );
}
...
function ProjectInfo() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center max-w-[612px] relative shrink-0 w-full" data-name="Project Info">
      <p className="font-['PP_NeueBit:Semi_Bold',sans-serif] leading-[72px] not-italic relative shrink-0 text-[#fefcfc] text-[80px] whitespace-nowrap">Signify</p>
...
function Group() {
  return (
    <div className="absolute inset-[0_78.77%_0_0]">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 38.8523 48">
        <g id="Group 176">
          <path d={svgPaths.p135d9e80} fill="var(--fill-0, #FEFCFC)" id="Vector" />
          <path d={svgPaths.p2b5d8b00} fill="var(--fill-0, #FEFCFC)" id="Vector_2" />
          <path d={svgPaths.pa791180} fill="var(--fill-0, #FEFCFC)" id="Vector_3" />
        </g>
      </svg>
    </div>
  );
...
function IconLogo() {
  return (
    <div className="absolute contents inset-[0_78.77%_0_0]" data-name="icon logo">
      <Group />
    </div>
  );
}
...
function Logoname() {
  return (
    <div className="absolute inset-[12.23%_0_0_26.14%]" data-name="logoname">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 135.157 42.1275">
        <g id="logoname">
          <path d={svgPaths.p6759680} fill="var(--fill-0, #FEFCFC)" id="Vector" />
          <path d={svgPaths.p36154900} fill="var(--fill-0, #FEFCFC)" id="Vector_2" />
          <path d={svgPaths.p31ca600} fill="var(--fill-0, #FEFCFC)" id="Vector_3" />
          <path d={svgPaths.p3899fe00} fill="var(--fill-0, #FEFCFC)" id="Vector_4" />
          <path d={svgPaths.p3d8e8980} fill="var(--fill-0, #FEFCFC)" id="Vector_5" />
          <path d={svgPaths.p38b8fc00} fill="var(--fill-0, #FEFCFC)" id="Vector_6" />
          <path d={svgPaths.p32bb0100} fill="var(--fill-0, #FEFCFC)" id="Vector_7" />
        </g>
      </svg>
    </div>
  );
...
function Logo() {
  return (
    <div className="absolute bottom-[48px] content-stretch flex flex-col items-start right-[60px]" data-name="Logo">
      <div className="h-[48px] relative shrink-0 w-[183px]" data-name="Logo">
        <Logo1 />
      </div>
    </div>
  );
...
function Container3() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start relative shrink-0 w-full" data-name="Container">
      <ul className="block font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#1e1c1c] text-[18px] w-full">
      ...
      <div className="content-stretch flex flex-col font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-start not-italic px-[20px] py-[40px] relative size-full text-[#1e1c1c]">
        ...
        <ul className="block leading-[0] list-disc min-w-full relative shrink-0 text-[18px] w-[min-content]">
          <li className="mb-0 ms-[27px]">
            <span className="leading-[28px]">Application</span>
          </li>
          <li className="mb-0 ms-[27px]">
            <span className="leading-[28px]">Brading guidline</span>
          </li>
          <li className="mb-0 ms-[27px]">
            <span className="leading-[28px]">Landing page</span>
          </li>
          <li className="ms-[27px]">
            <span className="leading-[28px]">Video TVC</span>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div className="flex-[1_0_0] min-w-px mr-[-1px] relative self-stretch" data-name="Container">
      ...
      <div className="content-stretch flex flex-col font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-start not-italic px-[20px] py-[40px] relative size-full text-[#1e1c1c]">
        ...
        <ul className="block leading-[0] list-disc min-w-full relative shrink-0 text-[18px] w-[min-content]">
          ...
          <li className="mb-0 ms-[27px]">
            <span className="leading-[28px]">User flow</span>
          </li>
          <li className="mb-0 ms-[27px]">
    ...
    <div className="flex-[1_0_0] min-w-px mr-[-1px] relative self-stretch" data-name="Container">
      ...
      <div className="content-stretch flex flex-col font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-start not-italic px-[20px] py-[40px] relative size-full text-[#1e1c1c]">
        ...
        <ul className="block leading-[0] min-w-full relative shrink-0 text-[18px] w-[min-content]">
          <li className="list-disc ms-[27px]">
            <span className="leading-[28px]">10 weeks</span>
          </li>
        </ul>
      </div>
    </div>
...
function Text() {
  return (
    <div className="relative shrink-0 w-full" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col font-['Inter:Regular',sans-serif] font-normal gap-[16px] items-start not-italic relative size-full text-[#1e1c1c] text-[18px]">
        <p className="leading-[28px] relative shrink-0 w-full">An app offers an AI-powered, seamless sign language learning and translation experience, making communication in sign language intuitive and efficient</p>
        <div className="leading-[0] relative shrink-0 w-full">
          <p className="leading-[28px] mb-0 whitespace-pre-wrap">Signify offers sign language interpretation for collaborative opportunities.</p>
          <ul className="list-disc">
            <li className="mb-0 ms-[27px]">
              <span className="leading-[28px]">Facilitating business operations and enhancing quality</span>
            </li>
            <li className="ms-[27px] whitespace-pre-wrap">
              <span className="leading-[28px]">
                {`Helping users access services and `}
                <br aria-hidden="true" />
...
function ItemDescription() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start justify-center min-w-px not-italic relative text-[#1e1c1c] text-[18px]" data-name="Item Description">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] relative shrink-0 w-full">1. Communication is not just text or sound</p>
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[0] relative shrink-0 w-full">
        <p className="leading-[28px] mb-0">Conversations are fast, emotional, and contextual.</p>
        <p className="leading-[28px]">Translating sound into meaningful interaction without losing intent is complex.</p>
      </div>
    </div>
  );
}
...
function ItemDescription1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[28px] min-w-px not-italic relative text-[#1e1c1c] text-[18px]" data-name="Item Description">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold relative shrink-0 w-full">Accessibility must be simple</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal relative shrink-0 w-full">The interface needs to be intuitive, fast, and require minimal learning.</p>
    </div>
  );
}
...
function ItemDescription2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[28px] min-w-px not-italic relative text-[#1e1c1c] text-[18px]" data-name="Item Description">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold relative shrink-0 w-full">Trust and reliability</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal relative shrink-0 w-full">Users must feel confident that the system works consistently in daily situations.</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Item List">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[16px] items-start relative size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[28px] not-italic relative shrink-0 text-[#1e1c1c] text-[18px] w-full">The current UX already serves an established user base.</p>
        <List />
      </div>
    </div>
  );
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[16px] items-start relative size-full">
        <div className="bg-white relative shrink-0 w-full" data-name="Container">
          ...
          <div className="content-stretch flex flex-col gap-[8px] items-start not-italic px-[32px] py-[20px] relative size-full">
            <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[#1e1c1c] text-[18px] w-full">How do deaf users really communicate?</p>
            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#626060] text-[16px] w-full">Not just replacing sound with text, but understanding how they naturally express meaning, emotion, and context in daily life.</p>
          </div>
        </div>
        <div className="bg-white relative shrink-0 w-full" data-name="Container">
          <div aria-hidden="true" className="absolute border-[#1e1c1c] border-l-3 border-solid inset-0 pointer-events-none shadow-[0px_1px_4px_0px_rgba(0,0,0,0.04)]" />
          <div className="content-stretch flex flex-col gap-[8px] items-start not-italic px-[32px] py-[20px] relative size-full">
            <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[#1e1c1c] text-[18px] w-full">What barriers do deaf users face in real situations?</p>
            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#626060] text-[16px] w-full">From simple conversations to unexpected moments, communication gaps create friction, dependency, and sometimes isolation.</p>
          </div>
        </div>
        <div className="bg-white relative shrink-0 w-full" data-name="Container">
          <div aria-hidden="true" className="absolute border-[#1e1c1c] border-l-3 border-solid inset-0 pointer-events-none shadow-[0px_1px_4px_0px_rgba(0,0,0,0.04)]" />
          <div className="content-stretch flex flex-col gap-[8px] items-start not-italic px-[32px] py-[20px] relative size-full">
            <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[#1e1c1c] text-[18px] w-full">What is a short-term vs long-term solution?</p>
            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#626060] text-[16px] w-full">Real-time translation can help immediately, but long-term impact requires broader awareness and integration of sign language.</p>
          </div>
        </div>
      </div>
    </div>
...
function Container17() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start not-italic relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[#1e1c1c] text-[20px] w-full">Real-time translation for confidence</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#626060] text-[16px] w-full">We designed a real-time translation experience to help users communicate naturally, reducing hesitation and increasing confidence in conversations.</p>
    </div>
  );
}
...
function Container18() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start not-italic relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[#1e1c1c] text-[20px] w-full">Researching from existing solutions</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#626060] text-[16px] w-full">Instead of reinventing everything, we analyzed current tools and identified their gaps - especially in usability, accuracy, and real-life application.</p>
    </div>
  );
}
...
function Container19() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start not-italic relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[#1e1c1c] text-[20px] w-full">Make learning engaging, not a burden</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#626060] text-[16px] w-full">We introduced gamified interactions to make the learning process more intuitive, enjoyable, and easier to sustain over time.</p>
    </div>
  );
}
...
function Container20() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start not-italic relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[#1e1c1c] text-[20px] w-full">Localized sign language understanding</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#626060] text-[16px] w-full">We focused on the most widely used form to create a shared standard - making it easier to learn, scale, and communicate across communities.</p>
    </div>
  );
}
...
function Container16() {
  return (
    <DetailHighlightsGrid
      items={[
        {
          title: "Real-time translation for confidence",
          description: "We designed a real-time translation experience to help users communicate naturally, reducing hesitation and increasing confidence in conversations.",
          imageSrc: imgImageOnlyOnePointerOnTheTimeScrubber2,
        },
        {
          title: "Researching from existing solutions",
          description: "Instead of reinventing everything, we analyzed current tools and identified their gaps - especially in usability, accuracy, and real-life application.",
          imageSrc: imgImageOnlyOnePointerOnTheTimeScrubber3,
        },
        {
          title: "Make learning engaging, not a burden",
          description: "We introduced gamified interactions to make the learning process more intuitive, enjoyable, and easier to sustain over time.",
          imageSrc: imgImageOnlyOnePointerOnTheTimeScrubber4,
        },
        {
          title: "Localized sign language understanding",
          description: "We focused on the most widely used form to create a shared standard - making it easier to learn, scale, and communicate across communities.",
  ...
  return (
    <DetailResultsShowcase
      items={[
        {
          value: "Interview",
          description: "Conducted user interviews and documentation to understand real communication needs and behaviors.",
        },
        {
          value: "↑↑",
          description: "Leveraged connections with educators and external experts to validate assumptions and improve solution quality.",
        },
        {
          value: "Full prototype",
          description: "Built a complete, testable prototype to validate flows, and real-world usability.",
        },
      ]}
...
function Container22() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start min-w-px relative" data-name="Container">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#626060] text-[16px] w-full">This project reflects my intention to build meaningful solutions for underserved communities.</p>
      <DetailQuoteBlock>Instead of jumping into solutions, I learned to step back - to understand the root cause and context. Only then can we design something truly sustainable.</DetailQuoteBlock>
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#626060] text-[16px] w-full">
        <p className="leading-[24px] mb-0">Through this process, I realized that communication is not only about tools, but about understanding how people express and connect.</p>
        <p className="leading-[24px]">Even as someone without hearing challenges, I saw how limited my perspective was before truly listening.</p>
      </div>
    </div>
  );
}
...
function ProjectPageSignify() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-w-px pb-px relative" data-name="Project page / Signify">
...
export default function Signify() {
  return (
    <div className="bg-[#f6f6f6] content-stretch flex items-start relative size-full" data-name="Signify">
